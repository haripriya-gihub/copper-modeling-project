...
def add_bg_from_url():
    st.markdown(
         ...
         <style>
         .stApp {{
             background-image: url("https://png.pngtree.com/background/20210709/original/pngtree-sketch-drawing-representation-plan-background-picture-image_430821.jpg");
...
with tab1:    
        ...
        if submit_button and flag==0:
            ...
            import pickle
            with open(r"C:\copper_modeling\model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'C:\copper_modeling\scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"C:\copper_modeling\t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"C:\copper_modeling\s.pkl", 'rb') as f:
...
with tab2: 
        ...
        if csubmit_button and cflag==0:
            import pickle
            with open(r"C:\copper_modeling\cmodel.pkl", 'rb') as file:
                cloaded_model = pickle.load(file)

            with open(r'C:\copper_modeling\cscaler.pkl', 'rb') as f:
                cscaler_loaded = pickle.load(f)

            with open(r"C:\copper_modeling\ct.pkl", 'rb') as f:
